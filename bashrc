...
#export TERMCOLORS=rxvt-unicode-256color
...
#export W3MIMGDISPLAY_PATH=~/.config/ranger/scripts

source ${HOME}/developer/bash-config/deb

source ${HOME}/developer/bash-config/bin
